...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <form action="/searchEpl" method="post" modelAttribute="Employee" class="form-inline my-2 my-lg-0">
...
<div class="container">
    <div class="row">
        <div class="col-lg-3">
            ...
            <form  action="/createEpl" method="post" modelAttribute="Employee" >
                ...
                <div class="form-group">
                    ...
                    <select name="department.dept_id" class="custom-select" required>
            ...
            <form  action="/updateEpl" method="post" modelAttribute="Employee">
                <div class="form-group">
                    <label for="exampleInputFullName">Full name</label>
                ...
                <div class="form-group">
                    ...
                    <select name="department.dept_id" class="custom-select" required>
                        <option selected>Select department</option>
                        <c:forEach items="${dept}" var="dept">
                            <option value="${dept.getDept_id()}" ${dept.getDept_id() == detailEmployee.department.getDept_id() ? 'selected="selected"' : ''}>${dept.getDept_name()}</option>
                        </c:forEach>
                    </select>
                </div>
        ...
        <div class="col-lg-9">
            <table class="table table-striped">
                ...
                <tbody>
                <c:forEach items="${epl}" var="employee">
                    <tr>
                        ...
                        <td>${employee.department.getDept_name()}</td>
                        <td><a href="/detailEpl/${employee.getId()}" class="btn btn-outline-info" >
                            <i class="fa-solid fa-pen"></i>
                        </a>

                                <input type="hidden" name="id" value="${employee.getId()}"/>
                                <a href="/deleteEpl/${employee.getId()}"  class="btn btn-outline-danger" >
            ...
            <ul class="pagination justify-content-end">
                ...
                <c:forEach var="i" begin="1" end="5">
                    <li class="page-item ${i == currentPage ? "active" : ""  }"><a class="page-link" href="/employeeList?page=${i}">${i}</a></li>
                </c:forEach>
